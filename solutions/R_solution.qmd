---
title: "R solution: Reconstruction of Pleistocene climate"
...
```{r}
#| include: false 
install.packages(setdiff(c("ggplot2", "reticulate", "reshape2", "ncdf4", "lattice"), rownames(installed.packages())))  
require(ggplot2)
require(ncdf4)
```
This is a possible solution to the exercise ["Reconstruction of Pleistocene climate based on assemblages of mammal microfossis from a cave in Hungary"](https://github.com/EmiliaJarochowska/Yankovich_cave).
...
```{r, eval=FALSE}
# Set eval = TRUE to download the dataset, it is 1.24 GB
